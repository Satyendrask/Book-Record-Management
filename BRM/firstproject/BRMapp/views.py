...
from BRMapp.forms import NewBookFrom,SearchForm
...
def add(request):
    if request.method=='POST':
        ...
        book.publisher=form.data['publisher']
        book.save()
    s="<style>body{background-color:aqua;}h1{color:black;}a{color:blue;}</style><h1>Record Stored</h1><a href='/BRMapp/view-books'>view all Books</a>"
